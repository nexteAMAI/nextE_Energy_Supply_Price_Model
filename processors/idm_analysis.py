...
def compute_idm_dam_spread(
    ...
    # Deduplicate indices (keep last value for each timestamp)
    idm_prices = idm_prices[~idm_prices.index.duplicated(keep="last")]
    dam_prices = dam_prices[~dam_prices.index.duplicated(keep="last")]
