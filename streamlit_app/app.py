...
# --- ACCESS CONTROL ---
# Authentication gate: requires passwords in Streamlit Secrets.
# If no passwords are configured, the app runs in open-access mode with a warning.
# To configure: Streamlit Cloud → App Settings → Secrets → paste from secrets.toml.template
